...
This project is a full-stack AI Chat Application developed during the **Devzey Summer Internship 2026**. It provides a ChatGPT-like experience where AI responses are streamed in real time instead of waiting for the complete response.
